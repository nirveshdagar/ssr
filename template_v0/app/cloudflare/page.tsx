...
const VALID_PAGE_SIZES = [25, 50, 100, 200, 500, 1000] as const
...
function CloudflarePageInner() {
  ...
  const filteredKeys = React.useMemo(() => {
    ...
    const sorted = [...rows].sort((a, b) => {
      let cmp = 0
      switch (sortKey) {
        // Natural sort on alias/email so "CF1, CF2, ..., CF10, CF11, CF100"
        // orders by the numeric suffix instead of lexically (which puts
        // CF10 between CF1 and CF2).
        case "alias": cmp = (a.alias || a.email).localeCompare(
          b.alias || b.email, undefined, { numeric: true, sensitivity: "base" },
        ); break
        case "email": cmp = a.email.localeCompare(
          b.email, undefined, { numeric: true, sensitivity: "base" },
        ); break
